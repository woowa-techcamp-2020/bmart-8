...
const Icons = [
  {
    ...
    routeUrl: '/category/second/1',
  },
  {
    name: '정육·계란',
    imageUrl: '/icon/egg.png',
    routeUrl: '/category/second/4',
  },
  {
    name: '국·메인요리',
    imageUrl: '/icon/mealkit.png',
    routeUrl: '/category/second/5',
  },
  {
    name: '음료·우유',
    imageUrl: '/icon/milk.png',
    routeUrl: '/category/second/8',
  },
  {
    name: '베이커리·치즈',
    imageUrl: '/icon/bread.png',
    routeUrl: '/category/second/9',
  },

  {
    name: '반려동물',
    imageUrl: '/icon/yasik.png',
    routeUrl: '/category/second/16',
  },
  {
    name: '뷰티·바디케어',
    imageUrl: '/icon/hair.png',
    routeUrl: '/category/second/12',
  },
  {
    name: '더보기',
